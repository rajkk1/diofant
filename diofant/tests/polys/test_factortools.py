...
def test_diofantissue_966():
    R, x = ring('x', FF(3622009729038561437))

    f = x**20 + x + 1
    r = f.factor_list()

    assert r == (1,
                 [(x + 1527979826208530989, 1), (x**2 + x + 1, 1),
                  (x**7 + 438545343576393689*x**6 + 1436775561657370591*x**5 +
                   3233206402032010217*x**4 + 540436064753524502*x**3 +
                   3482791898612765568*x**2 + 3446693059920336596*x +
                   11928009314168786, 1),
                  (x**10 + 1655484559253636758*x**9 + 2617426019549111896*x**8 +
                   3595725407337472284*x**7 + 550864904699371349*x**6 +
                   1713559816064195206*x**5 + 883664536846688315*x**4 +
                   1647656007680914340*x**3 + 2237828721779351999*x**2 +
                   294279128870273036*x + 1028748795591124108, 1)])
